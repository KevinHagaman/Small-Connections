  ...
  return (
    <Container component="main" maxWidth="xs" style={{backgroundColor: "#edf0f0", borderRadius: "10px"}}>
      ...
      <div className={classes.paper}>
        ...
        <Button onClick={props.onUserLoginClick} style={{color: "white", backgroundColor: "#3f51b5", marginTop: "10px"}}>User</Button>
        <Button onClick={props.onBusinessLoginClick} style={{marginTop: "10px"}}>Business</Button>
        </ButtonGroup>
